...
public class DemoMain {
    public static void main(String[] args) throws Exception {
        // 发送HTTP请求
        //DemoMain.postHttpRequest();
        // 发送HTTPS请求
        DemoMain.postHttpsRequest();
    }
    ...
    private static void postHttpRequest() throws Exception {
        ...
        String encBusiData = DataSecurityUtil.encrypt(MessageUtil
            .getBusiData_MSC8004().getBytes(), "SK803@!QLF-D25WEDA5E52DA");
