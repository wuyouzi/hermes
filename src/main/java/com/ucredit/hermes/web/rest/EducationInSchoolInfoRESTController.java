...
import com.ucredit.hermes.service.EducationInSchoolInfoService;
 ...
 */
@Controller
@RequestMapping("/rest/educationIn")
public class EducationInSchoolInfoRESTController {
    @Autowired
    private EducationInSchoolInfoService service;
    ...
    @ResponseBody
    public EducationInfo getEducationInSchoolInfo(
        ...
        return this.service.getEducationInSchoolInfo(operationName, name,
            documentNo, constraint, activeDays, newActiveDate, principal);
    }
}
