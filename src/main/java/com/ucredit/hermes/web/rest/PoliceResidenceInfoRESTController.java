...
import com.ucredit.hermes.service.PoliceResidenceInfoService;
...
public class PoliceResidenceInfoRESTController {
    @Autowired
    private PoliceResidenceInfoService service;
     ...
     */
    @RequestMapping(value = "/spceipal/{operationName}",
    ...
    public PoliceResidenceInfo getPoliceResidenceInfo(
        ...
        return this.service.getPoliceResidenceInfo(operationName, name,
