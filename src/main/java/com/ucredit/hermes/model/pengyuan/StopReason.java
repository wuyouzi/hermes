...
public class StopReason extends BaseModel<Integer> {

    private static final long serialVersionUID = -8645973046772387164L;
    ...
    public String toString() {
        return "StopReason [code=" + this.code + ", reason=" + this.reason
            + "]";
    }
