 ...
 */
@Entity
@Table(name = "legal_otherManager_infos")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class LegalOtherManagerInfo extends BaseModel<Integer> {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = 6516511961730862933L;
