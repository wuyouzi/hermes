 ...
 */
@Entity
@Table(name = "company_other_shareholder_infos")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CompanyOtherShareholderInfo extends BaseModel<Integer> {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = -4334947433121405095L;
